            ...
            Beneficiaries.native(function (err, collection) {
              ...
              collection.find(filterObject).toArray(function (err, beneficiaries) {
                ...
                let {
                  fields,
                  fieldNames
                } = FieldsService.getBeneficiariesDownloadFields(params.admin0pcode, params.cluster_id);
                ...
                return res.json(200, {
                  'data': {
                    'marker0': {
                      ...
                      lat: coordinates.lat,
                      lng: coordinates.lng,
                      message: '<h5 style="text-align:center; font-size:1.5rem; font-weight:100;">NO PROJECTS</h5>'
                    }
                  }
                });
              }
