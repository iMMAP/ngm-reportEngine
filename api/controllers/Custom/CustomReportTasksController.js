/**
 * CustomReportTaskController
 *
 * @description :: Custom Reports Task Management
...
var CustomReportTasksController = {
    ...
    CustomProject
      ...
      .exec( function( err, projects ){
        ...
        async.each( projects, function ( project, next ) {
          ...
          // find reports
          CustomReport.findOne( { project_id: new_report.project_id, report_month: new_report.report_month, report_year: new_report.report_year } ).then( function ( report ){
            ...
            // create reports
            CustomReport.updateOrCreate( findProject, { id: report.id }, new_report ).exec(function( err, report_result ){
              ...
              CustomTargetLocation
                ...
                .exec( function( err, target_locations ){
                  ...
                  CustomReportTasksController.getProjectReportLocations( report_result, target_locations, function( err, locations ){
                    ...
                    async.each( locations, function ( d, next ) {
                      ...
                      // find
                      CustomLocation.findOne( { project_id: project.id, target_location_reference_id: d.target_location_reference_id, report_month: d.report_month, report_year: d.report_year } ).then( function ( location ){
                        if( !location ) { location = { id: null } }
                        // relations set in getProjectReportLocations
                        CustomLocation.updateOrCreate( findProject, { id: location.id }, d ).exec(function( err, location_result ){
...
module.exports = CustomReportTasksController;
